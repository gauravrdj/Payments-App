//there is a hook provided by react-dom-router which is useSearchParams to get the query parameters
    ...
    return <div class="flex justify-center h-screen bg-gray-100">
        <div className="h-full flex flex-col justify-center">
            ...
            >
                ...
                <h2 class="text-3xl font-bold text-center text-purple-700">Send Money</h2>
                </div>
                <div class="p-6">
                <div class="flex items-center space-x-4">
                    ...
                    <h3 class="text-2xl font-semibold text-purple-600">{name}</h3>
                </div>
                <div class="space-y-4">
                    <div class="space-y-2">
                    <label
                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-purple-900"
                        for="amount"
                    >
                        Amount (in Rs)
                    </label>
